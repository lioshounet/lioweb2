  ...
  <div class="card">
    ...
    <div class="card-content">
      <form>
        <div class="row">
          <div class="col-md-5">
            <fg-input type="text" label="Company" :disabled="true" placeholder="莽砸导航" v-model="user.company">
            </fg-input>
          </div>
          <div class="col-md-3">
        ...
        <div class="row">
          <div class="col-md-12">
            <fg-input type="text" label="Address" placeholder="Address" v-model="user.address">
            </fg-input>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <fg-input type="number" label="Postal Code" placeholder="Postal Code" v-model="user.postalCode">
            </fg-input>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <label class="control-label"> Lamborghini Mercy, Your chick she so thirsty, I'm in that two seat
                Lambo.</label>
        ...
        <button type="submit" @click.prevent="updateProfile" class="btn btn-primary pull-right">Update Profile</button>
